/*
 ============================================================================
 Project    : Hybrid Opposition-Based Memetic Algorithm for the SUPBR Problem
 File       : hobma.c
...
static int start_hobma(parameters *params, int *num_eval_fit_function, int *num_used_generations);
...
int main(int argc, char **argv){
    ...
    score = start_hobma(&params, &num_eval_fit_function, &num_used_generations);
...
/*
int start_hobma(int *num_eval_fit_function, int pnumber_generations){
    //Variables
    int i,generation_number;
    permutation perm;
    population pop;
